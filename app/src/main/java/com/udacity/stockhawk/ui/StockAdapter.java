...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    public void onBindViewHolder(StockViewHolder holder, int position) {
        ...
        holder.change.setBackgroundResource((rawAbsoluteChange > 0)? R.drawable.percent_change_pill_green : R.drawable.percent_change_pill_red);

        String change = StockFormat.dollarFormatWithPlus(rawAbsoluteChange);
        String percentage = StockFormat.percentageFormat(percentageChange / 100);
